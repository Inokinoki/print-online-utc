    ...
    <div class="row">
        <div class="card col s12 m8 l6 xl6 offset-m2 offset-l3 offset-xl3" id="login-module">
            <div class="card-content">
                ...
                <form action="<?php echo View::$dirConfig['root']; ?>/Login/dologin" method="<?php echo POST; ?>">
                ...
                <div class="input-field col s12">
                    ...
                    <input id="input-birthday" name="birthday" type="number">
                    <label for="input-birthday" class="">Birthday</label>
                </div>
                <div id="birthday-tip" class="grey-text">Exemple: Si vous êtes né(e) le 21/12/1995, indiquez "2112"</div>
